...
var save_request = function(){
  ...
  var user_id = 1;
  var page_id = 4;
  var url = sprintf('/pages/save?user_id=%s&page_id=%s&elements=%s', user_id, page_id, elements );
  $.post('/pages/save/', function(data) {
    alert('yay')
  });
}
...
var e2 = {"box":{"1":{"width":1000,"content":"So Cool","min_height":200,"id":1}},"container":{"1":{"type":"simple","b_child":null,"a_child":1,"position":"a","id":1}},"root":1}
